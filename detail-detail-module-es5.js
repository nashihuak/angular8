...
var DetailPage = /** @class */ (function () {
    function DetailPage(route, cartService, nav, location) {
        this.route = route;
    ...
    DetailPage.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap.subscribe(function (param) { return _this.product = _this.products[param.get('id')]; });
        this.route.snapshot.paramMap.get('id');
        // console.log(this.route.snapshot.paramMap.get('id'), this.product)
        this.htmlStr = "\n            <h1>innerHtml\u5185\u5BB9</h1>\n            <h2 style=\"color: #1b75bb;\">\u6837\u5F0F\u81EA\u5B9A\u4E49</h2>\n        ";
    };
    DetailPage.prototype.addToCart = function (item) {
        this.cartService.addToCart(item);
        this.nav.navigateForward('/cart');
        // this.location.forward()
    };
    DetailPage.prototype.toUpper = function (e) {
        this.inputStr = e.toUpperCase();
    };
    DetailPage.prototype.getPhone = function (phone) {
        console.log(phone);
    };
    DetailPage.prototype.onSubmit = function (form) {
        console.log(form);
    };
    DetailPage.prototype.tapEmail = function (val) {
        console.log(val);
    };
...
var WordColorPipe = /** @class */ (function () {
    function WordColorPipe() {
    }
    WordColorPipe.prototype.transform = function (input, word) {
        if (!word)
            return input;
        var result = (input + '').replace(word, "<span style=\"color: #6ca4ff;\" class=\"tt\">" + word + "</span>");
        return result;
    };
