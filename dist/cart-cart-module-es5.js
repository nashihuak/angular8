...
var CartPage = /** @class */ (function () {
    function CartPage(cartService, formBuilder) {
    ...
    CartPage.prototype.ngOnDestroy = function () {
    ...
    CartPage.prototype.getShops = function () {
    ...
    CartPage.prototype.onSubmit = function (data) {
        console.log(data);
