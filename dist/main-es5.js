...
var routes = [
    ...
    {
        path: 'detail/:id',
        loadChildren: function () { return Promise.all(/*! import() | detail-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("detail-detail-module")]).then(__webpack_require__.bind(null, /*! ./detail/detail.module */ "./src/app/detail/detail.module.ts")).then(function (m) { return m.DetailPageModule; }); }
    },
    { path: 'tab1', loadChildren: './tab1/tab1.module#Tab1PageModule' },
    { path: 'top-bar', loadChildren: './top-bar/top-bar.module#TopBarPageModule' },
...
module.exports = __webpack_require__(/*! D:\ck\native-js\angular8\app\src\main.ts */"./src/main.ts");
